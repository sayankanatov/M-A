...
<body class="page page-{{Request::route()->getName() == 'service' ? 'specialists' : (Request::route()->getName() == 'company' ? 'сompaniy' : (Request::route()->getName() == 'lawyer' ? 'specialist' : (Request::route()->getName() == 'lawyers' ? 'specialists' : 'сompanies') ) )}}">
