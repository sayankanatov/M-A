...
<li class="treeview">
    <a href="#"><i class="fa fa-balance-scale"></i> <span>Компании</span> <i class="fa fa-angle-left pull-right"></i></a>
    <ul class="treeview-menu">
        ...
        <li><a href='{{ backpack_url('company_activated') }}'><i class='fa fa-building'></i> <span>Для подтверждения</span></a></li>
    </ul>
</li>

<li class="treeview">
    <a href="#"><i class="fa fa-balance-scale"></i> <span>Юристы</span> <i class="fa fa-angle-left pull-right"></i></a>
    <ul class="treeview-menu">
        ...
        <li><a href='{{ backpack_url('lawyer_activated') }}'><i class='fa fa-building'></i> <span>Для подтверждения</span></a></li>
    </ul>
</li>
