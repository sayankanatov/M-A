...
<div class="profile">
						...
						<div class="container">
							<div class="row lawyer">
								...
								<div class="col-2 lawyer_block-photo ">
									<img src="{{$info->logo ? $info->logo : asset('front3/image/Lawyers/Empty.png')}}" alt="Фото" class="photo">
								...
								<div class="col-7 lawyer_block-ingo block">
									<div class="name name-mobile">
										<a href="{{route('company',['id' => $info->alias,'city' => $city->alias])}}">{{$info->name}}</a>
										<div>
	...
	<div class="container">
		<main>
			...
			<section id="content1">
				<form role="form" action="{{route('home.company.update',['id' => $info->id])}}" method="post">
					@csrf
					<div class="row hr">
						<div class="col">
							<div class="profile_form">
								<div class="col"><span class="name">Название</span></div>
								<div class="col"><input type="text" placeholder="Название" name="name" value="{{$info->name}}"></div>
							</div>
							<div class="profile_form">
 	...
 	<div class="dm-overlay" id="win1">
        <div class="dm-table">
            <div class="dm-cell">
                <div class="dm-modal">
                	<form role="form" method="post" action="{{route('home.company.services',['id' => $info->id])}}">
                		@csrf
...
<!--ИЗМЕНИТЬ ФОТО START-->
 <div class="dm-overlay" id="win3">
 	<form role="form" method="post" action="{{route('home.company.photo',['id' => $info->id])}}" enctype="multipart/form-data">
 		@csrf
 		<div class="dm-table">
	        <div class="dm-cell">
	            <div class="dm-modal">
