...
@section('content')
                ...
                <div class="col-sm-4 factodes_block">
                    ...
                    <div class="factodes_text">
                        ...
                        <div class="factodes_fact"><a
                                href="{{route('lawyers',['city'=>$city->alias])}}"><span>{{$city->lawyers->count() ?? '538'}}</span>
                                юриста</a></div>
                    </div>
                </div>
                <div class="col-sm-4 factodes_block">
                    ...
                    <div class="factodes_text">
                        ...
                        <div class="factodes_fact"><a
                                href="{{route('companies',['city'=>$city->alias])}}"><span>{{$city->companies->count() ?? '538'}}</span>
                                компании</a></div>
                    </div>
                </div>
                <div class="col-sm-4 factodes_block">
                    ...
                    <div class="factodes_text">
                        ...
                        <div class="factodes_fact"><a
                                href="{{route('service',['city'=>$city->alias,'id' => 'notariusy'])}}"><span>{{App\Models\Lawyer::getByServiceInCity(65,$city->id,true)}}</span>
                                нотариуса</a></div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="special_block">
                                    <a href="{{route('service',['city'=>$city->alias,'id'=>$service->alias])}}"
                                       class="special_icon">
                                        ...
                                        <div
                                            class="special_fact">{{App\Models\Lawyer::getByServiceInCity($service->id,$city->id,true)}}
                                            <img src="{{asset('front3/image/Spesial/Group 1.svg')}}"
                                                 class="special_icon" alt="Иконка">
                                        </div>
                                    </a>
                                </div>
                            </div>
    ...
    @endif
    <!-- Более 120 юристов-->
    <section class="container law_cards">
        <div class="lawyers">
            <div class="container">
            ...
            <div class="col-lg-3 col-12">
                <a href="{{route('lawyers',['city'=>$city->alias])}}">
                ...
                <div class="row useful_blocks ">
                    @foreach($news as $item)
                        <div class="col-sm useful_block">
                            ...
                            <a href="{{route('news.show',['alias' => $item->alias])}}" class="useful_read">Читать
                                далее</a>
                        </div>
                    @endforeach
                </div>
    ...
    <div class="service">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="service_text-1">Требуется грамотная консультация юриста или адвоката? Хотите решить
                        возникшую
                        проблему цивилизованным способом? Сервис
                        Yuristy.kz – это лучший способ найти квалифицированного юриста, адвоката, юридическую фирму в
                        любой
                        отрасли права,
                        который поможет получить квалифицированную консультацию составить документы, подготовиться к
                        судебному
                        разбирательству
                        или решить проблему до суда. Данный сервис доступен по всему Казахстану.
                    </div>
                    <div class="service_text-2">На нашей площадке собраны лучшие юристы в сфере семейного, гражданского,
                        ...
                        отраслей права. Каждый из юристов имеет высшее образование и опыт судебного представительства.
                    </div>
                </div>
            </div>
            ...
            <div class="spoilerpanel">
                <div class="col-sm-10">
                    ...
                    <div class="text-subtitle">
                        <div>1. как правильно составить претензию продавцу, договор о купле-продаже, исковое заявление и
                            другие
                            документы;
                        </div>
                        ...
                        <div>7. особенности раздела участков земли и определение их границ в соответствии с
                            законодательными
                            нормами.
                        </div>
                        <div>8. получить бесплатную консультацию юриста и адвоката.</div>
                    </div>
                    <div class="text">Это лишь часть вопросов, интересующих наших пользователей. Хотите узнать еще
                        больше –
                        просто узнайте обо всех
                        возможностях сайта на практике!
                    </div>
                    <div class="text">Как получить консультацию юриста или адвоката?</div>
                    <div class="text">Получить помощь юриста максимально просто: укажите на сайте нужную отрасль права
                        или
                        название услуги (например,
                        консультация по алиментам, сопровождение в суде или составление претензии). Через несколько
                        секунд вам
                        будут открыты
                        результаты поиска. Вы можете изучить карточку о частных специалистах и компаниях, ознакомиться с
                        перечнем
                        услуг,
                        прайс-листом и отзывами клиентов.
                    </div>
                    <div class="text">После того, как вы подобрали по параметрам подходящего юриста, вы можете просто
                        позвонить
                        ему по телефону и обсудить
                        детали сотрудничества или написать онлайн или в месенджер вотсап.
                    </div>
                    <div class="text">Затем специалист поможет вам как можно быстрее решить вопросы. Бесплатные и
                        платные
                        консультации по телефону или онлайн,
                        личный прием, подготовка процессуальных документов – все это открыто с помощью нашего сервиса.
                    </div>
                    <div class="text">У нас представлены юридические фирмы, адвокатские конторы или частные юристы,
                        которые
                        предоставляют бесплатные
                        консультации, а также платные услуги. Сервис абсолютно бесплатен для физических лиц.
                    </div>
                    <div class="text">Сервис предусматривает удобные формы взаимодействия. Если вы не хотите звонить
                        сами,
                        просто оставьте контактные данные:
                        адвокат перезвонит вам в ближайшее время.
                    </div>
                    <div class="text">Правила регистрации для юристов или юридических фирм</div>
                    <div class="text">Портал сотрудничает не только с теми кому необходима помощь, но и с теми, кто
                        занимается
                        оказанием юридической помощи.
                        На сайте вы можете выложить информацию о себе, указать профессиональные навыки и стоимость
                        работы. Это
                        отличный способ
                        найти новых клиентов, получить положительные рекомендации, улучшить имидж.
                    </div>
                    <div class="text">Для регистрации укажите ваш статус, основную специализацию, данные о образовании и
                        опыте
                        работы по специальности. Если
                        есть возможность, дополните анкету ссылками на примеры выигранных дел, судебную практику. Мы
                        тщательно
                        проверяем каждую
                        анкету, поэтому рекомендуем публиковать только достоверные данные о себе.
                    </div>
                    <div class="text">После того, как вы подтвердили информацию о себе, указали контактные данные, вы
                        будете
                        получать первые отклики.
                    </div>
                    <div class="text-title">Преимущества Yuristy.kz</div>
                    <div class="text-2">1. Площадка будет полезна как обычным гражданам, которым нужно оказать
                        юридическую
                        помощь, так и профессиональным юристам,
                        с желанием регулярно получать разнообразные дела по своей сфере.
                    </div>
                    <div class="text-2">2. Здесь можно найти грамотного специалиста по юриспруденции всего за несколько
                        минут.
                        Мы гарантируем компетентность и
                        безупречную репутацию адвокатов.
                    </div>
                    <div class="text-2">3. Вы можете проконсультироваться со специалистом и решить вопрос без
                        дорогостоящего
                        юридического сопровождения. Многие
                        юристы и фирмы оказывают бесплатную юридическую кансультацию.
                    </div>
                    ...
                    <div class="text">Таким образом, Yuristy.kz делает доступной квалифицированную юридическую помощь
                        для
                        каждого человека, помогает выиграть
                        спор в суде или прийти к досудебному соглашению, выгодному для сторон. Мы подобрали для вас
                        лучших
                        правоведов, они с
                        блеском справляются даже с нестандартными ситуациями.
                    </div>
                </div>
            </div>
            <div class="spoiler">
