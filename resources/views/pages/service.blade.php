    ...
    <div class="content-top">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li class="breadcrumb-item">{{$service->name_ru}}</li>
            </ul>
            <h1 class="content-h1">
            ...
            <div class="content-top_line">
                ...
                {{-- <div class="content-top_sort">
                    <div class="content-top_sort-right">
                        ...
                        <a class="{{Input::get('sort', 'rating') ? 'sort-active' : ''}}" href="{{route('service',['city' =>$city->alias,'sort' => 'rating'])}}">рейтинг</a>
                        <a class="{{Input::get('sort', 'experience') ? 'sort-active' : ''}}" href="{{route('service',['city' =>$city->alias,'sort' => 'experience'])}}">стажу</a>
                        <a class="{{Input::get('sort', 'free') ? 'sort-active' : ''}}" href="{{route('service',['city'=>$city->alias])}}">бесплатная консультация</a>
                    </div>
                </div> --}}
            </div>        
        </div>
