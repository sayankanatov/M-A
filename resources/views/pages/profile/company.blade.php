<div class="container-fluid">
    <div class="row">
        <div class="col-md-3">
            <div class="content_item-left">
                <div class="content_item_img">
                    <img src="{{$info->logo ? $info->logo : asset('front2/img/spec-item.png')}}" alt="" width="150" height="150">
                </div>
        ...
        <div class="col-md-3">
            ...
            <div class="content_item_rev-linck">
                Рейтинг <a href="{{route('company',['id' => $info->alias,'city' => $city->alias])}}">12 Отзывов</a> 9.1
            </div>
            <div class="stars">
